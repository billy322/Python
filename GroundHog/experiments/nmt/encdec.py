...
class RecurrentLayerWithSearch(Layer):
    ...
    # step_fprop = decoder function
    # probs = messge for attention
    def step_fprop(self,
                   state_below,
                   state_before,
                   gater_below=None,
        ...
        1. *step_fprop = decoder function
        2. *probs = message for attention
        3. ref. flowchart of http://polarlion.github.io/nmt/2016/06/06/ground-show-alignment.html
...
class EncoderDecoderBase(object):
    ...
    def _create_transition_layers(self):
        ...
        # core part: RecurrentLayerWithSearch 
...
class Decoder(EncoderDecoderBase):
    ...
    def build_decoder(self, c, y,
        ...
        for level in range(self.num_levels):
            ...
            ### this is the main key result part
            ### alignment
            ### transitions = list 
...
class RNNEncoderDecoder(object):
    ...
    def create_next_probs_computer(self):
        # output from function: decoder.build_next_probs_predictor
